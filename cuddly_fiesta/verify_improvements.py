...
def verify_calibration_pulse():
    ...
    ax.set_title(
        "ECG Calibration Pulse Verification - Perfect Rectangle",
        fontsize=14,
        fontweight="bold",
    )
...
def verify_clinical_markers():
    ...
    ax.text(
        0.5,
        0.02,
        "← 25 mm/sec marker shows time scale",
    ...
    ax.set_title(
        "ECG with Clinical Markers - Matches Real ECG Format",
        fontsize=14,
        fontweight="bold",
    )
...
def show_timing_verification():
    ...
    print("Calibration pulse timing:")
